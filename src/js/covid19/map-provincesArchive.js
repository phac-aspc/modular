...
let queryStringOptions = {
	...
	"pt": {
		"num": ["total", "deaths", "total_last14", "deaths_last14", "total_last7", "deaths_last7", "tests", "recover", "active"],
...
// 	if ((queryStringValues.stat == "num" && (queryStringValues.measure == "total" || queryStringValues.measure == "deaths" || queryStringValues.measure == "recover" || queryStringValues.measure == "tested" || queryStringValues.measure == "active" )) || (queryStringValues.stat == "rate" && (queryStringValues.measure == "total" || queryStringValues.measure == "deaths" || queryStringValues.measure == "tested" || queryStringValues.measure == "active" ))) {
// 		$("#dropdownType3").val(queryStringValues.stat)
// 		$("#dropdownType1").val(queryStringValues.measure)
...
function buildMap(mapJSON) {
	...
	function buildMap2(mapJSON) {
		...
		if (iframeElementMap == null) {
			...
			if (typeof(queryStringValues.stat) != "undefined" && typeof(queryStringValues.measure) != "undefined") {
				if ((queryStringValues.stat == "num" && (queryStringValues.measure == "total" || queryStringValues.measure == "deaths" || queryStringValues.measure == "recover" || queryStringValues.measure == "tests")) || (queryStringValues.stat == "rate" && (queryStringValues.measure == "total" || queryStringValues.measure == "deaths" || queryStringValues.measure == "tests")) || (queryStringValues.stat == "avg" && (queryStringValues.measure == "tests_last7" || queryStringValues.measure == "ratetests_last7" || queryStringValues.measure == "positivity_last7"))) {
					$("#dropdownType3").val(queryStringValues.stat)
					$("#dropdownType1").val(queryStringValues.measure)
			...
			d3.select("#legend")
				...
				.text(function() {
					if (language == "en") {
						...
						else if ((typeCases == "numtotal") || (typeCases == "numactive")) {
	...
	function color(value) {
		if (typeCases == "numtotal") {
			...
			if (value > 40000) return COLOR_SCALE["6+"];
			else if (value > 30000) return COLOR_SCALE["5-6"];
			else if (value > 20000) return COLOR_SCALE["4-5"];
			else if (value > 10000) return COLOR_SCALE["3-4"];
			else if (value > 1000) return COLOR_SCALE["2-3"];
			else if (value > 0) return COLOR_SCALE["1-2"]
			else return COLOR_SCALE["N/A"];
			...
			if (value > 600) return COLOR_SCALE["6+"];
			else if (value > 400) return COLOR_SCALE["5-6"];
			else if (value > 200) return COLOR_SCALE["4-5"];
			else if (value > 100) return COLOR_SCALE["3-4"];
			else if (value > 50) return COLOR_SCALE["2-3"];
			else if (value > 0) return COLOR_SCALE["1-2"]
			else return COLOR_SCALE["N/A"];
	...
	function updateLegendText(d, i) {
		if (typeCases == "numtotal") {
			...
			if (language == "en") {
				...
				if (i == 0) {
					return "40 000 et plus";
				}
				else if (i == 1) {
					return "30 000 à 39 000";
				}
				else if (i == 2) {
	...
	$('#dropdownType5').on('change', function() {
		...
		if ($('#dropdownType5').val() == "rate") {
			...
			$('#dropdownType6 option[value="tests"]').prop("disabled", "true");
			$('#dropdownType6 option[value="tests"]').css("display", "none");
			$('#dropdownType6 option[value="recover"]').css("display", "none");
			$('#dropdownType6 option[value="recover"]').prop("disabled", "true");
			$('#dropdownType6 option[value="tests_last7"]').prop("disabled", "true");
			$('#dropdownType6 option[value="tests_last7"]').css("display", "none");
			$('#dropdownType6 option[value="ratetests_last7"]').prop("disabled", "true");
			$('#dropdownType6 option[value="ratetests_last7"]').css("display", "none");
			$('#txtTotalMod').css('display', '');
			//relativeSwitch = 1;
			...
			$('#dropdownType6 option[value="tests_last7"]').prop("disabled", "");
			$('#dropdownType6 option[value="tests_last7"]').css("display", "");
			$('#dropdownType6 option[value="ratetests_last7"]').prop("disabled", "");
			$('#dropdownType6 option[value="ratetests_last7"]').css("display", "");
			$('#txtTotalMod').css('display', 'none');
			//$("#relativeSwitch").prop("disabled","");				
		}
	...
	function createTable() {
		...
		d3.selectAll("#dataTableb tbody tr").remove();

		var dataRowb = d3.select("#dataTableb tbody").selectAll("tr")
			.data(timeData2)
			.enter()
			.append("tr")
			.attr("class", function(d) {
	...
	function createTableIframe() {
		...
		dataRow.append("td")
			...
			.text(function(d) {
				if (timeData[d.key][currentDate]) {
					return d3.format(",d")(timeData[d.key][currentDate][0].ratetests);
				}
				else {
					return "0";
				}
		...
		// .text(function(d){
		//     if(timeData[d.key][currentDate]){
		//         return d3.format(",d")(timeData[d.key][currentDate][0].numprob);
		//     }else{
		//       return "0";
		//     }
		// });
		...
		// .text(function(d){
		//     if(timeData[d.key][currentDate]){
		//         return d3.format(",d")(timeData[d.key][currentDate][0].numtoday);
		//     }else{
		//       return "0";
		//     }
		// });
...
// d3.csv("/covid/weather/data/FSA_HR2018.csv", function(data){
// 	let translateJSON = {};

// 	data.forEacch(function(d,i){
