...
var currentRegion2, currentDate2, indexDate2, timeData, timeData2, timeData3, timeData4, nestedData, datesArray2;
...
function buildRegionsMap() {
	...
	function buildRegionsMap2(mapJSON) {
		...
		//Repatriated Totals
		const repatriated = d3.select("#mapGroup2").datum(nestedData[99][0]).append("g")
		...
		//Add Canada2 Totals
		const mapCanada = d3.select("#mapGroup2").datum(nestedData[1][0]).append("g")
			.attr("id", "Canada2")
			.attr("tabindex", 0)
