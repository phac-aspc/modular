...
var dateField, data, dataExceptions, NML, dataStatements, dataAgeGroups, nTotal, dataExposureByPT, dataHospSeverity, dataHospVentICU, dataSeverity, dataSymptoms, dataVOC, dataVOCByDate, labIndicators, labIndicatorsDate;
...
function processDataEpiSummary(dateFieldInt, dataInt, dataExceptionsInt, NMLInt, dataStatementsInt, dataAgeGroupsInt, nTotalInt, dataExposureByPTInt, dataHospSeverityInt, dataHospVentICUInt, dataSeverityInt, dataSymptomsInt, dataVOCInt, labIndicatorsInt) {
	...
	labIndicatorsDate = d3.timeParse("%d-%m-%Y")(labIndicators[labIndicators.length - 1].date);
...
function processDate(data){
	...
	$(".detailedCasesDate").text("May 28, 2021, 7 pm EST");
	processPrintOptions()
}
...
function nationalNumbers() {
    ...
    if (language == "en") {
        ...
        d3.selectAll(".rateTests").text(numberFormat(timeDataCanada[labIndexCanada].values[0].values[0]["avgratetests_last7"]));
        ...
        d3.selectAll(".percentActive").text(d3.format("0.1f")(+timeDataCanada[0].values[0].values[0]["percentactive"]));
        d3.selectAll(".recovered").text(numberFormat(timeDataCanada[0].values[0].values[0]["numrecover"]));
        d3.selectAll(".percentRecovered").text(d3.format("0.1f")(+timeDataCanada[0].values[0].values[0]["percentrecover"]));
        d3.selectAll(".deaths").text(numberFormat(timeDataCanada[0].values[0].values[0]["numdeaths"]));
        d3.selectAll(".percentDeaths").text(d3.format("0.1f")(+timeDataCanada[0].values[0].values[0]["percentdeath"]));
        ...
        d3.selectAll(".percentPositive").text(d3.format("0.1f")(+timeDataCanada[labIndexCanada].values[0].values[0]["avgpositivity_last7"]));
    }
    else {
        d3.selectAll(".numTests").text(numberFormat(timeDataCanada[0].values[0].values[0]["numtests"]));
        d3.selectAll(".rateTests").text(numberFormat(timeDataCanada[labIndexCanada].values[0].values[0]["avgratetests_last7"]));
        d3.selectAll(".totalCases").text(numberFormat(timeDataCanada[0].values[0].values[0]["numtotal"]));
        d3.selectAll(".active").text(numberFormat(timeDataCanada[0].values[0].values[0]["numactive"]));
        d3.selectAll(".percentActive").text(d3.format("0.1f")(+timeDataCanada[0].values[0].values[0]["percentactive"]).replace(".", ","));
        d3.selectAll(".recovered").text(numberFormat(timeDataCanada[0].values[0].values[0]["numrecover"]));
        d3.selectAll(".percentRecovered").text(d3.format("0.1f")(+timeDataCanada[0].values[0].values[0]["percentrecover"]).replace(".", ","));
        d3.selectAll(".deaths").text(numberFormat(timeDataCanada[0].values[0].values[0]["numdeaths"]));
        d3.selectAll(".percentDeaths").text(d3.format("0.1f")(+timeDataCanada[0].values[0].values[0]["percentdeath"]).replace(".", ","));
        d3.selectAll(".newCases").text(numberFormat(timeDataCanada[0].values[0].values[0]["numtoday"]));
        d3.selectAll(".newDeaths").text(numberFormat(timeDataCanada[0].values[0].values[0]["numdeathstoday"]));
        d3.selectAll(".percentPositive").text(d3.format("0.1f")(+timeDataCanada[labIndexCanada].values[0].values[0]["avgpositivity_last7"]).replace(".", ","));
    }
